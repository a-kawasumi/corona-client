...
const Icon = styled.svg`
  ...
  height: 50vh;
`;
const PrefectureGroup = styled.g`
  cursor: pointer;
...
export const JapanMap: VFC<Props> = (props) => {
  const { onClickPrefecture } = props;
  const onClick = useCallback(
    (el) => {
      const code: string = el.currentTarget.getAttribute("data-code");
      onClickPrefecture(Number(code));
    },
    [onClickPrefecture]
  );

  return (
    <Icon viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg">
      <g transform="matrix(1.028807, 0, 0, 1.028807, -47.544239, -28.806583)">
        ...
        {/* line */}
        <g stroke="#EEEEEE" strokeWidth="12">
